...
PLIST_NAME="com.kingson4wu.telegram-bridge.plist"
...
if launchctl list "com.kingson4wu.telegram-bridge" >/dev/null 2>&1; then
...
launchctl start "com.kingson4wu.telegram-bridge"

echo "[install-launchd] Done. Check status with:"
echo "  launchctl list com.kingson4wu.telegram-bridge"
